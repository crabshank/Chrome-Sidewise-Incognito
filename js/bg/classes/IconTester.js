...
IconTester.prototype = {
	...
	onTestIconsFinished: function(a) {
		...
		0 < a.length ? (a.forEach(function(a) {
			...
			"pageTree"), savePageTree(recentlyClosedTree, "recentlyClosedTree"), this.badNodesFound.push(a), this.doTestIcons(this.onTestIconsFinished)) : (this.destroyTestIconsPage(), setTimeout(function() {
